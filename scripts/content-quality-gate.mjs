 ...
 *
 *   node scripts/content-quality-gate.mjs <file.md> [--content-dir content/blog]
...
if (args[0] === '--audit') {
  const dir = args[1]
  const contentDir = args[2] || 'content/blog'
...
if (args.length && !args[0].startsWith('--')) {
  ...
  const contentDir = dirFlag !== -1 ? args[dirFlag + 1] : 'content/blog'
