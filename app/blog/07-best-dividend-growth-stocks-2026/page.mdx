  ...
  - '@context': https://schema.org
    ...
    mainEntity:
      - '@type': Question
        ...
        acceptedAnswer:
          '@type': Answer
          text: 'Dividend yield is current income (annual dividend ÷ stock price). Dividend growth is the rate dividends increase annually. High-yield stocks maximize current income; dividend growth stocks maximize long-term wealth. Most investors benefit from balancing both.'
      - '@type': Question
        name: 'How do Dividend Aristocrats compare to Dividend Kings?'
        acceptedAnswer:
          '@type': Answer
          text: 'Dividend Aristocrats have 25+ years of consecutive increases. Dividend Kings have 50+ years. Kings are exceptionally rare (40 US companies) but represent the safest, most predictable dividend growth. Both outperform the market significantly over 20+ year periods.'
      - '@type': Question
        name: 'What compound annual growth rate (CAGR) is realistic for dividend stocks?'
        acceptedAnswer:
          '@type': Answer
          text: 'Dividend growth stocks historically achieve 5-10% annual dividend CAGRs, with total returns (dividends + capital appreciation) reaching 8-12%. Quality dividend aristocrats average 6-7% dividend growth, which doubles your dividend every 10-12 years.'
      - '@type': Question
        name: 'Should I prioritize price appreciation or dividend growth?'
        acceptedAnswer:
          '@type': Answer
          text: 'For true wealth building, total return (capital gains + dividends) matters most. Stocks with 3% yields and 8% price appreciation beat stocks with 7% yields and 1% price appreciation. However, dividend growth provides compounding benefits that accelerate long-term wealth.'
      - '@type': Question
        name: 'How do I identify stocks with sustainable dividend growth potential?'
        acceptedAnswer:
          '@type': Answer
          text: 'Look for consistent earnings growth, payout ratios below 65%, sector tailwinds, and 10+ year histories of uninterrupted dividend increases. Use the dividend payout ratio to earnings (FCF payout) as your safety metric—ratios above 80% signal growth limits.'
---

## Quick Answer

Dividend growth stocks target companies increasing dividends 8-12% annually, transforming modest starting yields into 20%+ yields on your original investment within 20-30 years. Focus on dividend aristocrats (25+ year streaks) and kings (50+ years) for reliable compounding.

**Key stats:**
- Average dividend growth rate: 8% to 12% annually
- Historical 5-10 year CAGR: 6% to 7%
- Starting yields: 2% to 3% (low but growth-focused)
- Total returns (dividends + appreciation): 8% to 12% annually

**Top recommendations:**
- Dividend aristocrats (25+ year consecutive increases)
- Dividend kings (50+ year streaks - exceptionally rare)
- Companies with earnings growth supporting dividend increases
...
Want to compare dividend growth stocks against high-yield alternatives? Check our guides on [monthly dividend stocks](/01-best-monthly-dividend-stocks-2026/) for immediate income and [dividend ETFs](/02-top-10-dividend-etfs-for-passive-income/) for automatic diversification.
...
Use our [Dividend Growth Calculator](/calculators/dividend-growth), [DRIP Calculator](/calculators/drip), and [Retirement Income Calculator](/calculators/retirement-income) to model 20-30 year dividend growth scenarios. See how dividend reinvestment and capital appreciation compound into extraordinary outcomes. Ready to get started? Compare top brokers with our [broker comparison guide](/brokers) to find the best platforms for dividend growth investing.
