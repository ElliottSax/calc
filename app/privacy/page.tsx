...
export default function Page() {
  return (
    <div className="container mx-auto px-4 py-12 max-w-3xl prose prose-slate dark:prose-invert">
      ...
      <p className="text-muted-foreground mb-4">Dividend Engines is designed to work without collecting personal information. The calculators run in your browser; the numbers you enter are not transmitted to or stored on our servers.</p>
