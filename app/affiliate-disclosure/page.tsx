...
export default function Page() {
  return (
    <div className="container mx-auto px-4 py-12 max-w-3xl prose prose-slate dark:prose-invert">
      ...
      <p className="text-muted-foreground mb-4">Some links on Dividend Engines may be affiliate links to brokerages or financial products. If you open an account or make a purchase through one, we may earn a commission at no additional cost to you.</p>
