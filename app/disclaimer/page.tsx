...
export default function Page() {
  return (
    <div className="container mx-auto px-4 py-12 max-w-3xl prose prose-slate dark:prose-invert">
      ...
      <p className="text-muted-foreground mb-4">Dividend Calculator Pro provides educational tools, not financial advice.</p>
