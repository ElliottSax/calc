...
const CALCULATORS = [
  ...
  { href: '/calculators/retirement-income', name: 'Retirement Income Calculator', desc: 'Calculate the portfolio capital and monthly savings needed to retire on dividend income.' },
